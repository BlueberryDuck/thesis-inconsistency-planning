...
\begin{defn}[Operator~\cite{Bylander1994}]
    \label{defn:operator}
    An operator $o$ is a triple $\langle \text{precond}(o), \text{add}(o), \text{delete}(o) \rangle$ where $\text{precond}(o) \subseteq P$ are the preconditions, $\text{add}(o) \subseteq P$ are the add effects, and $\text{delete}(o) \subseteq P$ are the delete effects.
\end{defn}
...
\begin{defn}[Solvability~\cite{Bylander1994}]
    ...
    A planning problem $\langle P, O, I, G \rangle$ is solvable if there exists a plan and unsolvable otherwise.
\end{defn}
