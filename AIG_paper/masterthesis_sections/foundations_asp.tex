...
\ac{ASP} is a declarative programming paradigm based on the stable model semantics of logic programs~\cite{Dimopoulos1997}. This section provides formal definitions of \ac{ASP} concepts used in the implementation chapter.
