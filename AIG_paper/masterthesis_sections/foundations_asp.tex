...
\ac{ASP} provides a natural framework for encoding planning problems. The modern tool \textit{plasp}~3 by Dimopoulos et al.~\cite{Dimopoulos2019} translates \ac{PDDL} specifications into \ac{ASP} programs where answer sets correspond to valid plans. The system generates rules encoding operator applicability, effect application, and goal satisfaction.
