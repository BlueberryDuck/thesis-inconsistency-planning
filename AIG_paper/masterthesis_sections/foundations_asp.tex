...
Dimopoulos et al.~\cite{Dimopoulos1997} describe \ac{ASP} as a declarative programming paradigm based on stable model semantics for logic programs. This section provides formal definitions of \ac{ASP} concepts used in the implementation chapter.
