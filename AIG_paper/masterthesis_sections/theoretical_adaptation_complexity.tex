...
\begin{prop}[Goal Sequencing Conflict Profile Complexity]
    ...
    Given $S_{\text{reach}}$, computing $I^{\text{scope}}_{\text{GS}}$ and
    $I^{\text{struct}}_{\text{GS}}$ requires $O(|G|^2 \cdot |S_{\text{reach}}|^2 \cdot |O|)$
...
\begin{table}[ht]
    ...
    \begin{tabular}{l|l|l}
        ...
        $I_{\text{GS}}$ (given $S_{\text{reach}}$) & $O(|G|^2 \cdot |S_{\text{reach}}|^2 \cdot |O|)$ & $O(|S_{\text{reach}}|)$ \\
        \hline
    \end{tabular}
\end{table}
