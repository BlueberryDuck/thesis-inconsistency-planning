...
This section presents the proposals informally, establishing the conceptual framework and intuition before the formal mathematical definitions in Section~\ref{sec:formalization}. Each proposal is motivated by the structural taxonomy introduced in Section~\ref{sec:taxonomy} and illustrated through concrete scenarios demonstrating varying degrees of inconsistency within each structural category.
