...
\begin{table}[ht]
  ...
  \begin{tabular}{llll}
    ...
    Light Switch     & 2c       & Simple pair     & $\mathcal{I}_{\text{MX}}$ \\
    Traffic Light    & 2c       & Complete clique & $\mathcal{I}_{\text{MX}}$ \\
    Trust and Travel & 2c       & Unidirectional  & $\mathcal{I}_{\text{GS}}$ \\
    Rival Alliances  & 2c       & Symmetric       & $\mathcal{I}_{\text{GS}}$ \\
    \hline
  \end{tabular}
