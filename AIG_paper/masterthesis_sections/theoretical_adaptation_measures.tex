...
\begin{defn}[Mutex Pair Count]
    Let $\langle P, O, I, G \rangle$ be a planning problem. The measure $\mathcal{I}^{\text{struct}}_{\text{MX}}$ counting two-element subsets of $G$ whose elements are mutex is defined as:
    \begin{equation*}
