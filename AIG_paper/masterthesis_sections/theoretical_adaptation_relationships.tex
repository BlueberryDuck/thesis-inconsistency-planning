...
\begin{proof}
    \begin{enumerate}
        ...
        \item The maximum number of unordered pairs among
              $\mathcal{I}^{\text{scope}}_{\text{MX}}(\Pi, h)$ goals is $\binom{\mathcal{I}^{\text{scope}}_{\text{MX}}(\Pi, h)}{2}$.

        \item The maximum number of ordered pairs among
              $\mathcal{I}^{\text{scope}}_{\text{GS}}(\Pi, h)$ goals is $n(n-1)$ where
              $n = \mathcal{I}^{\text{scope}}_{\text{GS}}(\Pi, h)$.
    \end{enumerate}
\end{proof}
