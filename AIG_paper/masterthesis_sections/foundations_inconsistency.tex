...
\cite{Corea2022} developed inconsistency measures for temporal logic applied to declarative process specifications. Their work demonstrates that traditional measures fail to adequately capture temporal operators, requiring domain-specific semantics for meaningful conflict quantification. This parallels findings that naive propositional encodings of planning problems yield uninformative measure values, motivating planning-native measures.
