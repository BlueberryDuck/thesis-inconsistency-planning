...
A knowledge base $K$ is \emph{consistent} if there exists an interpretation $\mathcal{I}$ such that $\mathcal{I} \models \phi$ for every $\phi \in K$. Otherwise, $K$ is \emph{inconsistent}.

The set of all interpretations of $\mathcal{L}$ is denoted as $\text{Mod}(\mathcal{L})$. The set of models of a formula set $K$ is defined as:
\begin{equation*}
...
\begin{defn}
    \label{defn:inconsistency-measure}
...
The structural approach to inconsistency measurement focuses on identifying specific subsets that characterize conflicts within knowledge bases.
...
These structural concepts give rise to quantitative inconsistency measures that count or analyze these sets:

\begin{defn}
    \label{defn:imi}
    The \emph{\ac{MIS}-based inconsistency measure} of a knowledge base $K$ is defined as:
    \begin{equation*}
...
\begin{defn}
    \label{defn:imc}
    The \emph{\ac{MCS}-based inconsistency measure} of a knowledge base $K$ is defined as:
    \begin{equation*}
