\begin{figure}[ht]
    ...
    \begin{tikzpicture}[
        ...
        \node[font=\small\bfseries] (all-label) at (0, 0.8)
    ...
    \end{tikzpicture}
    \caption[Diagnostic measure hierarchy.]{Diagnostic measure hierarchy. Sequencing conflicts are a subset of mutex relationships; unreachable (goal) propositions are excluded from both measures.}
