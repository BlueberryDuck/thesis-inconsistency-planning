...
The thesis will be organized into seven sections:

\begin{description}
  \item[section 1: Introduction] Overview of the problem domain, motivation, and summary of contributions.
  \item[section 2: Foundations] Background on inconsistency measurement, \ac{ASP}, and classical planning formalisms.
  \item[section 3: Related Work] Survey of existing work on inconsistency measures and unsolvable planning problems.
  \item[section 4: Theoretical Adaptation] Formal adaptation of selected inconsistency measures to planning, with definitions and examples.
  \item[section 5: Implementation] Computational complexity analysis and \ac{ASP}-based prototype development.
  \item[section 6: Evaluation] Experimental setup, benchmarking results, and analysis.
  \item[section 7: Conclusion] Summary of findings, limitations, and future work.
\end{description}
...
\begin{description}
  \item[Months 1-2:] Literature review and theoretical foundations (sections 2-3).
  \item[Months 2-4:] Theoretical development and formal adaptation of measures (section 4).
  \item[Months 3-5:] Implementation of \ac{ASP}-based algorithms and prototype development (section 5).
  \item[Months 4-6:] Experimental evaluation and thesis write-up (sections 1, 5-6).
\end{description}
